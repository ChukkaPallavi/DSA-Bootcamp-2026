...
* Executed programs for multiple student records.
* Practiced basic Pointer programs.
...
* Revision of Structure Syntax.
* Learned the difference between Static Data and Dynamic Data.
...
* Structures allow grouping different data types into a single unit.
...
* Understand Dynamic Memory Allocation in detail.
